...
public class AssetPortfolio {
    ...
    public static void main(String args[]) throws Exception {
        ...
        DataLoader loader = new YahooDataLoader(from, to);
        final Map<String, StockList> values = new HashMap<>();
        Arrays.asList(tickers.get(ISHARES_WORLD_QUALITY_DIVIDEND)).forEach(x -> values.put(x, loader.loadData(x))
        );
