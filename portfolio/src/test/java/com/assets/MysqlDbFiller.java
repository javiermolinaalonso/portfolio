...
import com.assets.data.loader.mysql.MySqlDataLoader;
...
public class MysqlDbFiller {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataLoader defaultLoader = new YahooDataLoader(from, to);
        String userName = "root";
        String password = "my-secret-pw";
        String url = "jdbc:mysql://localhost:3306/portfolio";

        final MySqlDataLoader mySqlDataLoader = new MySqlDataLoader(defaultLoader, DriverManager.getConnection(url, userName, password));

        long time = System.currentTimeMillis();
        final StockList intc = mySqlDataLoader.loadData("INTC");
