...
public class CorrelationThread implements Callable<BigDecimal> {
    ...
    public CorrelationThread(List<BigDecimal> x, List<BigDecimal> y, BigDecimal xMean, BigDecimal yMean, Integer n, Integer from, Integer to) {
        super();
        this.X = x;
        this.Y = y;
        this.xMean = xMean;
