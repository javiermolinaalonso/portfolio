...
import com.assets.portfolio.data.loader.mysql.MySqlDataLoader;
...
public class MysqlDbFiller {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final MySqlDataLoader mySqlDataLoader = new MySqlDataLoader(defaultLoader, DriverManager.getConnection(url, userName, password), "portfolio");
